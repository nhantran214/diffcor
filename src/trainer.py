...
class Trainer(object):
    def __init__(self,
        ...
        print("self deviceeeeeeeeeee", self.device)
        ...
        self.amp = amp
        self.efficientnet_list = ['efficientnetb0', 'efficientnetb1', 'efficientnetb2', 'efficientnetb3',
                             'efficientnetb4', 'efficientnetb5', 'efficientnetb6', 'efficientnetb7',]
        self.vit_list = ["vit_b_16", "vit_b_32", "vit_l_16", "vit_l_32", "vit_h_14",]
    ...
    def train_epoch(self,epoch):
        ...
        for batch_idx,(data,label) in enumerate(self.train_loader): 
            ...
            with amp_class():
                ...
                # extract feature
                if self.model_name in self.efficientnet_list:
                    feature = self.model.extract_features(data)
                elif self.model_name in self.vit_list:
                    feats = self.model._process_input(data)
                    # Expand the CLS token to the full batch
                    batch_class_token = self.model.class_token.expand(data.shape[0], -1, -1)
