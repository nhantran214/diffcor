...
class Celeba(BaseDataset):
    def __init__(self,root,train_type="train",transform=None,num_classes=2, diffusion_type = 'ldm-dd'):
        super(Celeba,self).__init__(root=root, transform=transform, num_classes=num_classes)
        cwd = os.getcwd()
        ...
        if train_type == "train":
            ...
            print('real pathhhhhhhhh', real_path_full)
