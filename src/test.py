...
def test_model(args):
    ...
    if args.dataset == "celeba":
        test_dataset = Celeba(args.root,"test",test_augs, diffusion_type = args.diffusion_type)
...
if __name__ == '__main__':
    ...
    arg('--shuffle', type=bool, default=False)
    arg('--real-weight', type=float, default=4.0)
    # transforms
    arg('--aug-name', type=str, default="None") # None, RE, RandCrop, RaAug
    ...
    arg('--exp_name', type=str, default='cross_validate')
    arg('--gpus', type=str, default='0')
    arg('--log-interval', type=int, default=100)
    arg("--epochs", type=int, default=1)
    arg("--load-model-path", type=str, default='ckpt/celeba/train/efficientnetb4/epoch_5_acc_100.000_auc_100.000.pth')
